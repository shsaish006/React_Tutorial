// Program-20: Employee List Example with Space Theme and Toggle Functionality
// Uses variables a, b, c, d for data without employee names, with functional "Explore" button.
...
export default class EmployeeTable extends Component {
    ...
    render() {
        // Data: array of employee objects with b = ID, d = Salary
        let a = [
            { b: 101, d: 5000 },
            { b: 104, d: 8000 },
            { b: 103, d: 7000 },
        ...
        return (
            <div style={containerStyle}>
                ...
                {this.state.showTable && (
                    <table style={tableStyle}>
                        ...
                        <tbody>
                            {a.map((emp) => (
                                <tr key={emp.b}>
                                    <td style={tdStyle}>{emp.b}</td>
                                    <td style={tdStyle}>{emp.d}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                ...
                <footer style={{ marginTop: '40px', color: '#aaa', fontSize: '14px' }}>
                    Footer - Employee Table Space Theme
                </footer>

                {/* Stars */}
                <div style={{ position: 'absolute', top: '20%', left: '15%', width: '2px', height: '2px', background: 'white', borderRadius: '50%', animation: 'twinkle 2s infinite alternate' }} />
